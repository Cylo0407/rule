...
public class MatchesBody {
    ...
    private String rule_department;
    private String rule_fileName;
    private String rule_text;
    private Integer relevance;

    public MatchesBody(Double similarity, Integer rule_id, String rule_department, String rule_fileName, String rule_text, Integer relevance) {
        this.similarity = similarity;
        this.rule_id = rule_id;
        this.rule_department = rule_department;
    ...
    public String getRule_department() {
        return rule_department;
    }

    public void setRule_department(String rule_department) {
        this.rule_department = rule_department;
    }
